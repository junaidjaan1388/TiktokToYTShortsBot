    ...
    <>
             ...
             <form
               ...
               <div className="relative justify-center items-center gap-x-3 ">
                ...
                <button className='absolute top-0 right-0 p-2.5 bg-purple-700 rounded-r-lg border border-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800' onClick={handlePaste}>
